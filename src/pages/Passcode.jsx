...
setLoader(false)
  ...
  return (
    ...
    <Card style={{ width: '30rem',border:'0px',boxShadow:'3px 5px 23px 16px whitesmoke',borderRadius:'15px',cursor:'pointer' }}>
      ...
      />
         <Button className='confirm' variant='danger' style={{borderRadius:'20px',width:'90px',border:'1px solid #f54952',marginLeft:'30px'}} type="button" onClick={()=>handleSubmit()} >Confirm</Button>
         </div>
